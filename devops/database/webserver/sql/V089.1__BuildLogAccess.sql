CREATE TABLE resource_build_log_access (
    FOREIGN KEY(org_id)
...
CREATE UNIQUE INDEX ON resource_build_log_access(role_id);

INSERT INTO resource_build_log_access (role_id, org_id, access_type)
SELECT id, org_id, 7

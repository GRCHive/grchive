CREATE TABLE resource_shell_script_runs_access (
    FOREIGN KEY(org_id)
...
CREATE UNIQUE INDEX ON resource_shell_script_runs_access(role_id);

INSERT INTO resource_shell_script_runs_access (role_id, org_id, access_type)
SELECT id, org_id, 7

...
DROP CONSTRAINT IF EXISTS code_to_client_data_link_code_id_org_id_fkey,
DROP CONSTRAINT IF EXISTS code_to_client_data_link_code_id_fkey,
...
ALTER TABLE code_to_client_data_link 
DROP CONSTRAINT IF EXISTS code_to_client_data_link_data_id_org_id_fkey,
DROP CONSTRAINT IF EXISTS code_to_client_data_link_data_id_fkey,

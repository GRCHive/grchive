...
docker build --tag registry.gitlab.com/grchive/grchive/kotlin:latest .
...
docker run \
    ...
    --mount source=datavolume,target=/data registry.gitlab.com/grchive/grchive/kotlin:latest \

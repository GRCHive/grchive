...
const (
	...
	DashboardOrgClientScriptsTemplateKey
	DashboardOrgSingleClientScriptTemplateKey
	DashboardOrgLogsTemplateKey
	DashboardOrgBuildLogsTemplateKey
	DashboardOrgRunLogsTemplateKey
	DashboardOrgScriptScheduleTemplateKey
	DashboardOrgSingleScriptRequestTemplateKey
	DashboardOrgSingleShellRequestTemplateKey
	DashboardOrgShellsTemplateKey
	DashboardOrgSingleShellTemplateKey
	DashboardOrgSingleShellRunTemplateKey
	// Error Keys
	Error403TemplateKey
	Error404TemplateKey
)
...
func RegisterTemplates() {
	...
	allTemplates[DashboardOrgClientDataTemplateKey] =
		defaultLoadTemplateWithDashboardBase("src/webserver/templates/dashboard/dashboardClientData.tmpl")
	allTemplates[DashboardOrgSingleClientDataTemplateKey] =
		defaultLoadTemplateWithDashboardBase("src/webserver/templates/dashboard/dashboardSingleClientData.tmpl")

	allTemplates[DashboardOrgClientScriptsTemplateKey] =
		defaultLoadTemplateWithDashboardBase("src/webserver/templates/dashboard/dashboardClientScripts.tmpl")
	allTemplates[DashboardOrgSingleClientScriptTemplateKey] =
		defaultLoadTemplateWithDashboardBase("src/webserver/templates/dashboard/dashboardSingleClientScript.tmpl")
	...
	allTemplates[DashboardOrgScriptScheduleTemplateKey] =
		defaultLoadTemplateWithDashboardBase("src/webserver/templates/dashboard/dashboardScriptSchedule.tmpl")

	allTemplates[DashboardOrgSingleScriptRequestTemplateKey] =
		defaultLoadTemplateWithDashboardBase("src/webserver/templates/dashboard/dashboardSingleScriptRequest.tmpl")
	allTemplates[DashboardOrgSingleShellRequestTemplateKey] =
		defaultLoadTemplateWithDashboardBase("src/webserver/templates/dashboard/dashboardSingleShellRequest.tmpl")

	allTemplates[DashboardOrgShellsTemplateKey] =
		defaultLoadTemplateWithDashboardBase("src/webserver/templates/dashboard/dashboardShells.tmpl")
	allTemplates[DashboardOrgSingleShellTemplateKey] =
		defaultLoadTemplateWithDashboardBase("src/webserver/templates/dashboard/dashboardSingleShell.tmpl")
	allTemplates[DashboardOrgSingleShellRunTemplateKey] =
		defaultLoadTemplateWithDashboardBase("src/webserver/templates/dashboard/dashboardSingleShellRun.tmpl")

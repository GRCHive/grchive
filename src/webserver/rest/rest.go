...
func registerControlAPIPaths(r *mux.Router) {
	...
	s.HandleFunc(core.ApiLinkDocCatControlEndpoint, linkControlToDocumentCategory).Methods("POST").Name(webcore.LinkDocCatControlRouteName)
	s.HandleFunc(core.ApiUnlinkDocCatControlEndpoint, unlinkControlToDocumentCategory).Methods("POST").Name(webcore.UnlinkDocCatControlRouteName)
...
func registerControlDocumentationAPIPaths(r *mux.Router) {
	...
	s.HandleFunc(core.ApiGetControlDocumentationCategoryEndpoint, getControlDocumentationCategory).Methods("GET").Name(webcore.GetControlDocCatRouteName)
	s.HandleFunc(core.ApiAllControlDocumentationCategoryEndpoint, allControlDocumentationCategories).Methods("GET").Name(webcore.AllControlDocCatRouteName)

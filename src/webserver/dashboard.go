...
func createOrganizationSubrouter(r *mux.Router) {
	...
	s.HandleFunc(core.DashboardOrgDashboardUrl, render.RenderDashboardOrgDashboardPage).Name(webcore.DashboardOrgDashboardRouteName)
	...
	s.HandleFunc(core.DashboardOrgSingleShellRequestEndpoint, render.RenderSingleShellRequest).Name(webcore.SingleShellRequestRouteName)
...
func createOrganizationSystemSubrouter(r *mux.Router) {
	...
	s.HandleFunc(core.DashboardSingleShellRunEndpoint, render.RenderSingleShellRun).Name(webcore.SingleShellRunRouteName)
}

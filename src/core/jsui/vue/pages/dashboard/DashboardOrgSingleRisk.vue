<template>
    <section class="max-height">
        ...
        <v-content>
            <full-edit-risk-component></full-edit-risk-component>
        </v-content>
    </section>
</template>
...
import FullEditRiskComponent from '../../components/dashboard/FullEditRiskComponent.vue'
import Vue from 'vue'
